...
public abstract class RootUser extends  FullTimeEmployee implements Serializable {
    ...
    RootUser(String uuid,String first_name , String last_name,String user_name, int age, String tel_number, String address,byte[] user_pin ,String role,double basic_salary, Company company){
        super(uuid,first_name,last_name,user_name,age,tel_number,address,user_pin,role,basic_salary,company);
